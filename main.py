...
if __name__ == '__main__':
    ...
    if not args.test:
        ...
        train_rewards = simulate_mbrl(env, model, plan_mode=args.plan_mode, num_epochs=num_epochs, max_path_length=max_path_length, mpc_horizon=mpc_horizon,
        ...
        with open(f'{args.model_type}_{args.plan_mode}.npy', 'wb') as f:
                np.save(f, train_rewards)
    else:
